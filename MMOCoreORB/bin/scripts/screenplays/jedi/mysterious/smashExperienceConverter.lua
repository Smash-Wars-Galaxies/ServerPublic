...
SmashExperienceConverter = ScreenPlay:new {
	xpConversion = {
		combat = {
			{ "bountyhunter", 3 },
			{ "combat_general", 3 },
			{ "combat_meleespecialize_onehand", 15 },
			{ "combat_meleespecialize_polearm", 15 },
			{ "combat_meleespecialize_twohand", 15 },
			{ "combat_meleespecialize_unarmed", 15 },
			{ "combat_rangedspecialize_carbine", 15 },
			{ "combat_rangedspecialize_heavy", 15 },
			{ "combat_rangedspecialize_pistol", 15 },
			{ "combat_rangedspecialize_rifle", 15 },
			{ "squadleader", 30 }
		},
		senses = {
