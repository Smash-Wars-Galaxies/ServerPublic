...
http PUT "http://localhost:44443/v1/admin/config/Core3/Resource/ForageMultiplier?value=3.0" "Authorization:Bearer VJaSqx0UyJb3AnmcU0AU+x3a"
...
http PUT "http://localhost:44443/v1/admin/config/Core3/Resource/HarvestMultiplier?value=1.5" "Authorization:Bearer VJaSqx0UyJb3AnmcU0AU+x3a"
